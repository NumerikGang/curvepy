...
def gen_test_cases_for_all_forward_for_one_value(min, max, val_min, val_max):
    print("[")
    for _ in range(TEST_CASES):
        x = [random.randint(val_min, val_max) for _ in range(random.randint(min, max) + 1)]
...
if __name__ == '__main__':
    ...
    gen_test_cases_for_all_forward_for_one_value(15, 50, -20, 20)
    # xs = gen_n(16)
