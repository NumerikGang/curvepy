...
def test_parametrized_for_de_casteljau(m: List[List[int]], res: List[List[float]], t: float):
...
def test_parametrized_for_de_casteljau_parallel(m: List[List[int]], res: List[List[float]], ts: List[float]):
